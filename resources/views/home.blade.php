	      ...
	      <div class="container-fluid">
	        <div class="il_logo_container">
				<a class="navbar-brand" href="/">
					<img src="{{ asset('public/media/ilyrics_logo.svg')}}" alt="">
				</a>
			</div>
	        <a class="navbar-brand navbar-brand--resp" href="/">
				<img style="width:80px;" src="{{ asset('public/media/ilyrics_logo.svg')}}" alt="">
			</a>
				
	        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarsExample09" aria-controls="navbarsExample09" aria-expanded="false" aria-label="Toggle navigation">
	          <img src="{{ asset('public/media/menu_icon_humberger2.svg')}}">
	        </button>
	        ...
	        <div class="collapse navbar-collapse" id="navbarsExample09">
	          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	            ...
	            <li class="nav-item">
	              <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true"><img src="{{ asset('public/media/search.svg')}}"></a>
	            </li>
	          </ul>
	          <div class="mr-0">
				...
				<div class="col-12 col-md-6 align-self-center">
					<div>
						...
						<div class="input-group mb-3 mt-5" style="max-width:500px;">
						  ...
						  <button class="btn btn--large" type="button" id="button-addon2" style="min-width:80px;"><img src="{{ asset('public/media/search_white.svg')}}"></button>
						</div>
					</div>
				</div>
			</div>
			  ...
			  <div class="card--playlist__image" style="background-image: url('https://iLyrics.org/uploads/download_(32).jpg');">
				  <div class="dropdown float-end">
					  <a href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">
					   	<img src="{{ asset('public/media/dote_dote_dote.svg')}}">
					  </a>
					  <ul class="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="dropdownMenuButton1">
					    <li><a class="dropdown-item" href="#"><img class="mr-2" src="{{ asset('public/media/file-earmark-plus.svg')}}"> Add to your Playlist</a></li>
					    <li><a class="dropdown-item" href="#"><img class="mr-2" src="{{ asset('public/media/collection-play.svg')}}"> Play All</a></li>
					    <li><a class="dropdown-item" href="#"><img class="mr-2" src="{{ asset('public/media/file-earmark-arrow-down.svg')}}"> Download</a></li>
					    <li><a class="dropdown-item" href="#"><img class="mr-2" src="{{ asset('public/media/share-fill.svg')}}"> Share</a></li>
					  </ul>
				  </div>
			  </div>
		  ...
		  <div class="col-md-6 col-12">
			  <div class="card card--layrics">
				  ...
				  <div class="card--layrics__options">
					  <div class="dropdown float-end">
						  <a href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">
						   	<img src="{{ asset('public/media/dote_dote_dote_2.svg')}}">
						  </a>
						  <ul class="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="dropdownMenuButton1">
						    <li><a class="dropdown-item" href="#"><img class="mr-2" src="{{ asset('public/media/file-earmark-plus.svg')}}"> Add to your Playlist</a></li>
						    <li><a class="dropdown-item" href="#"><img class="mr-2" src="{{ asset('public/media/collection-play.svg')}}"> Play All</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-md-5">
				<a class="mb-3" href="#"><img style="width:140px;" src="{{ asset('public/media/ilyrics_logo.svg')}}"></a>
			...
			<div class="col-12 col-md-7">
				<div class="row">
					...
					<div class="col-12 col-md-6">
		                ...
		                <a href="https://www.facebook.com/iLyricsO/"><img src="{{ asset('public/media/social_facebook.svg')}}"></a>
		                <a href="https://twitter.com/ILyricsgo"><img src="{{ asset('public/media/social_icon_twitter.svg')}}"></a>
		                <a href="https://www.instagram.com/ilyricsgo/"><img style="width:32px;" src="{{ asset('public/media/social_icon_svginstagram.svg')}}"></a>
					</div>
				</div>
			</div>
		</div>
