...
//        console.info(argfind);
    ...
    $.fn.audioplayer = function(o) {
        var defaults = {
            ...
            ,autoplay: 'off'
            ,cue: 'on'
            ,swf_location: ""//==the location of the flash backup
            ,swffull_location: ""//==the location of the flash backup
            ...
            ,settings_useflashplayer: 'off' // off or on or auto
...
//                    img.src= cthis.attr('data-source');
            ...
            function check_ready(){
                ...
                //console.log($mediaNode_.readyState);
                if(type=='youtube'){

                }else{
                    if(typeof(_cmedia)!='undefined'){//|| o.type=='soundcloud'

//                        console.info($mediaNode_.readyState, o.type);
...
//                        return false;
                        if(_cmedia.nodeName!="AUDIO" || o.type=='shoutcast' ){
                            ...
                            //console.info($mediaNode_.readyState);
            ...
            function setup_structure(){
                ...
                aux+='<div class="con-controls"><div class="the-bg"></div><div class="con-playpause"><div class="playbtn"><div class="play-icon"></div></div><div class="pausebtn" style="display:none"><div class="pause-icon"></div></div></div>';
...
//                console.info('setup_media()')
            ...
            function destroy_media(){
                ...
                if(_cmedia){
                    ...
                    //console.log($mediaNode_, $mediaNode_.src);
                    if(_cmedia.children){

                        //$mediaNode_.children().remove();
                    }
...
//                console.info(cthis.hasClass('loaded'))
                ...
                if(is_flashplayer==false){
                    ...
                    if(o.settings_backup_type=='light'){
                        ...
                        if(typeof(_cmedia)!="undefined" && _cmedia.fn_getSoundDuration){
                            eval("totalDuration = parseFloat($mediaNode_.fn_getsoundduration"+cthisId+"())");
                        }
                    }
                }
                if(typeof(_cmedia)!="undefined"){
                    if(_cmedia.nodeName=='AUDIO'){
                        //console.info($mediaNode_);
                ...
                if(type!='fake'){
                    if(dzsap_list && dzsap_list.indexOf(cthis)==-1){
                        dzsap_list.push(cthis);
                    }
...
//                                            console.info(audioBuffer);
                                ...
                                //console.log($mediaNode_, $mediaNode_.get(0))
                    ...
                    if(is_flashplayer==true){
                        if(o.settings_backup_type=='light'){
                            if(str_ie8=='' && typeof(_cmedia)!="undefined"){
                                ...
                                eval("if(typeof $mediaNode_.fn_getsoundduration"+cthisId+" != 'undefined'){time_total = parseFloat($mediaNode_.fn_getsoundduration"+cthisId+"())};");
                                eval("if(typeof $mediaNode_.fn_getsoundcurrtime"+cthisId+" != 'undefined'){time_curr = parseFloat($mediaNode_.fn_getsoundcurrtime"+cthisId+"())};");
                            }
                        }


                        //console.log($mediaNode_.fn_getSoundCurrTime());
                    }else{
                        if(o.type!='shoutcast'){
...
//                console.log(time_curr, time_total);
            ...
            function handle_end() {
                /* Si quiero que se pare la reproducción al terminar el audio, poner la funcion pause_media(); */
...
//                        console.info(o.design_skin, _currTime,  _metaArtistCon, _metaArtistCon.css('left'), parseInt(_metaArtistCon.css('left'),10), parseInt(_metaArtistCon.css('left'),10) + _metaArtistCon_w + 10);
                ...
                if(type=='audio'){
                    if(audioBuffer!=null){
                        ...
                        if(is_flashplayer==true){
                            ...
                            if(o.settings_backup_type=='light'){
                                if(str_ie8==''){
                                    eval("$mediaNode_.fn_seek_to"+cthisId+"("+arg+")");
                                }
                            }
                            play_media();
                        }else{
            ...
            function set_volume(arg){
                ...
                if(type=='audio'){
                    if(is_flashplayer==true){
                        ...
                        if(o.settings_backup_type=='light'){
                            if(str_ie8==''){
                                eval("$mediaNode_.fn_volumeset"+cthisId+"(arg)");
                            }
                        }
                        //play_cmedia();
                    }else{
                ...
                if(type=='audio'){
                    ...
                    if(audioBuffer!=null){
                        ...
                        if(is_flashplayer==true && o.settings_backup_type=='light' && cthis.css('display')!='none'){
                            if(o.settings_backup_type=='light'){
                                eval("$mediaNode_.fn_pausemedia"+cthisId+"()");
                            }
                        }
                        else{
                            if(_cmedia){
            ...
            function pause_media_iOS(pargs){
...
//                    console.info(!is_ie8(), dzsap_list[i].get(0), typeof dzsap_list[i].get(0)!="undefined", typeof dzsap_list[i].get(0).api_pause_media!="undefined")
                    if(!is_ie8() && typeof dzsap_list[i].get(0)!="undefined" && typeof dzsap_list[i].get(0).api_pause_media!="undefined" &&dzsap_list[i].get(0)!=cthis.get(0)){
                        ...
                        //console.info(dzsap_list[i].get(0),dzsap_list[i].data('type_audio_stop_buffer_on_unfocus'))
                ...
                if(type=='audio'){
                    ...
                    if(audioBuffer!=null){
                        ...
                        if(is_flashplayer==true && cthis.css('display')!='none'){
                            //console.log(cthis);
                            if(o.settings_backup_type=='light'){
                                eval("$mediaNode_.fn_playmedia"+cthisId+"()");
                            }
...
window.requestAnimFrame = (function() {
    ...
    return window.requestAnimationFrame ||
        ...
        function(/* function */callback, /* DOMElement */element) {
            window.setTimeout(callback, 10000 / 2);
        };
})();
